...
{{< alert icon="📌" text="Los temas que se tocan en el curso Cálculo II esta relacionado con el cálculo integral, donde se aprenderá distintas técnicas de integración." />}}

<br>

{{< alert icon="👉" text="**Requisitos**: Para un mejor entendimiento del Curso de Cálculo II se necesitan comprender los conceptos vistos en el cuso de Cálculo I, mas que nada los conceptos de derivadas." />}}
